                      ...
                      nexmo.conversations.members.add(
                        ...
                        (error, agent) => {
                          ...
                          if (agent) { 
                            ...
                            // var options = {
                            //   'method': 'GET',
                            //   'url': 'https://b95e4401.ngrok.io/predict',
                            //   'headers': {
                            //   }
                            // };
                            ...
                            //   console.log("activeConversationDetails" + activeConversationDetails.conversation)

                            //   activeConversationDetails.conversation.sendCustomEvent({ type: 'churn_prediction', body:response}).then(() => {
